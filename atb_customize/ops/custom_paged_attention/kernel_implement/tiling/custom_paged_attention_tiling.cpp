...
*/
#include "custom_paged_attention_tiling.h"
...
std::string AsdOpsTensorDescToString(const Mki::TensorDesc &tensorDesc)
{
    std::stringstream ss;
...
{
    ATB_LOG(INFO) << "custom::PagedAttentionTiling called";
    auto param = AnyCast<OpParam::PagedAttention>(launchParam.GetParam());
    ...
    ATB_LOG(INFO) << "tilingHost: " << (void*)tilingHost << " tilingSize: " << tilingSize;
    ATB_LOG(INFO) << "maskType: " << param.maskType;
    ATB_LOG(INFO) << "launchParam.GetInTensorCount(): " << launchParam.GetInTensorCount();
    ATB_LOG(INFO) << "query: " << AsdOpsTensorDescToString(launchParam.GetInTensor(0).desc);
    ATB_LOG(INFO) << "keyCache: " << AsdOpsTensorDescToString(launchParam.GetInTensor(1).desc);
    ATB_LOG(INFO) << "valueCache: " << AsdOpsTensorDescToString(launchParam.GetInTensor(2).desc);
    ATB_LOG(INFO) << "blockTables: " << AsdOpsTensorDescToString(launchParam.GetInTensor(3).desc);
    ATB_LOG(INFO) << "mask: " << AsdOpsTensorDescToString(launchParam.GetInTensor(4).desc);
    ATB_LOG(INFO) << "custom_tiling_para_gm: " << AsdOpsTensorDescToString(launchParam.GetInTensor(5).desc) << "tensor data: " << (void*)launchParam.GetInTensor(5).data;
