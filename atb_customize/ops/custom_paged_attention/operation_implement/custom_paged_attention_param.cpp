...
namespace atb {
bool CustomPagedAttentionFusionVariantPackParam::BuildFromTensor(const SVector<Mki::Tensor> &inTensors,
...
bool CustomPagedAttentionFusionVariantPackParam::BuildFromTensor310P(const SVector<Mki::Tensor> &inTensors, bool needQLens,
                                                               int qLensIndex)
{
    batchRunStatus.clear();
    contextLens.clear();
...
bool CustomPagedAttentionFusionVariantPackParam::ParseQLens(const SVector<Mki::Tensor> &inTensors, int qLensIndex)
{
