...
#ifndef CUSTOM_PAGED_ATTENTION_OPS_RUNNER_H
#define CUSTOM_PAGED_ATTENTION_OPS_RUNNER_H
...
namespace atb {
class CustomPagedAttentionOpsRunner : public OpsRunner {
public:
    std::size_t IntensorSizeGenerate();
    explicit CustomPagedAttentionOpsRunner(const infer::PagedAttentionParam &param);
    ~CustomPagedAttentionOpsRunner() override;
