...
#ifndef CUSTOM_PAGED_ATTENTION_OPERATION_H
#define CUSTOM_PAGED_ATTENTION_OPERATION_H
...
class CustomPagedAttentionOperation : public OperationBase {
public:
    explicit CustomPagedAttentionOperation(const infer::PagedAttentionParam &param);
    ~CustomPagedAttentionOperation() override;
    ...
    // 通过GraphPreLaunch模式获取基类的runnerVariantPack_.tilingBuffer和tilingBufferSize
    
    ::atb::customize::TilingBufferInfo GetHostTilingBuffer() const;
