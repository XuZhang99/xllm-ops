...
function(add_ops_src_copy)
    ...
    get_filename_component(_op_name ${SRC_COPY_SRC} NAME)
    file(GLOB SRC_FILES ${SRC_COPY_SRC}/*)
    # message(STATUS "SRC_FILES: ${SRC_FILES}")
    list(FILTER SRC_FILES EXCLUDE REGEX "op_host")
    list(FILTER SRC_FILES EXCLUDE REGEX ".*_tiling.h|.*_cpu.cpp|.*_tiling.cc|.*_l0.cpp|.*_l0.h|.*sort.h|.*sort.cpp|.*CMakeLists.txt")
    if (SRC_COPY_SRC MATCHES "pp_mat_mul")
        #ppmatmul
        message(STATUS "pp_mat_mul start")
        message(STATUS "SRC_FILES: ${SRC_FILES}")
        list(FILTER SRC_FILES EXCLUDE REGEX ".*_common_tiling.h|.*_default.h|.*_default.cpp|.*_info.h")
    elseif (SRC_COPY_SRC MATCHES "multi_latent_attention")
    #multi_latent_attention
        list(FILTER SRC_FILES EXCLUDE REGEX ".*common.h|.*compare.h|.*math*|.*mla.h|.*_dependency*|.*_impl*")
    endif ()
    message(STATUS "_op_name: ${_op_name}")
    message(STATUS "SRC_FILES: ${SRC_FILES}")
