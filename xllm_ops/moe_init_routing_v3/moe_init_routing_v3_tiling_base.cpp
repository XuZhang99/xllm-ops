...
{   
    OPS_LOG_D(context, "TilingPrepareForMoeInitRountingV3 enter.");
    ...
    OPS_CHECK(
        ...
        OPS_LOG_E(context, "TilingPrepareForMoeInitRountingV3 fail to get core num."), return ge::GRAPH_FAILED);
    ...
    OPS_CHECK(
        ...
        OPS_LOG_E(context, "TilingPrepareForMoeInitRountingV3 fail to get ub size."), return ge::GRAPH_FAILED);
