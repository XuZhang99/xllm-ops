...
class BeamSearch {
 public:
  ...
  __aicore__ inline void Init(GM_ADDR token_ids,
                              GM_ADDR log_probs,
                              GM_ADDR top_tokens,
                              GM_ADDR top_probs,
  ...
  __aicore__ inline void AlignUpDataCopy(AscendC::LocalTensor<TokenIdType> dst,
                                         ...
                                         int32_t length);
  __aicore__ inline void AlignUpDataCopyGm(AscendC::GlobalTensor<TokenIdType> dst,
                                           AscendC::LocalTensor<TokenIdType> src,
                                           int32_t length);
  __aicore__ inline void AlignUpDataCopyProb(AscendC::LocalTensor<LogProbType> dst,
                                             AscendC::GlobalTensor<LogProbType> src,
                                             int32_t length);
  __aicore__ inline void AlignUpDataCopyProbSlice(AscendC::LocalTensor<LogProbType> dst,
                                                 AscendC::GlobalTensor<LogProbType> src,
                                                 int32_t length,
  ...
  __aicore__ inline void AlignUpCopyProb(AscendC::LocalTensor<LogProbType> dst,
                                         ...
                                         int32_t length);
  __aicore__ inline void Psum(int32_t request_idx);
  __aicore__ inline void TopKWithSorted(
      int32_t request_idx,
  ...
  __aicore__ inline void StackWithOutput(
      int32_t request_idx,
      AscendC::LocalTensor<LogProbType>& prefix_top_probs,
      AscendC::LocalTensor<int32_t>& prefix_top_index);
 ...
 private:
  ...
  AscendC::TQue<AscendC::QuePosition::VECIN,1> tmp_queue;
  AscendC::TBuf<AscendC::TPosition::VECCALC> tmp_buf2;
  AscendC::TBuf<AscendC::TPosition::VECCALC> tmp_buf3;
  AscendC::TBuf<AscendC::TPosition::VECCALC> tmp_buf4;
  AscendC::TBuf<AscendC::TPosition::VECCALC> tmp_buf5;
  AscendC::TBuf<AscendC::TPosition::VECCALC> tmp_buf6;
  AscendC::TBuf<AscendC::TPosition::VECCALC> tmp_buf7;
  AscendC::TBuf<AscendC::TPosition::VECCALC> tmp_buf8;
  AscendC::TBuf<AscendC::TPosition::VECCALC> tmp_buf9;
  AscendC::TBuf<AscendC::TPosition::VECCALC> tmp_buf10;
  AscendC::TBuf<AscendC::TPosition::VECCALC> tmp_buf11;
};
